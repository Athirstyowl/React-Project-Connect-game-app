...
export const getComputerMove = (gameBoard) => {
    let moveChecks = [
        //vertical moves
        {
            indexes: [0, 4, 8, 12], //object and its property
            max: 4,
            step: 1
        },
        //horizontal
        {
            indexes: [0, 1, 2, 3], //object and its property
            max: 16,
            step: 4
        },
        //diagonal 1
        {
            indexes: [0, 5, 10, 15], //object and its property
            max: 16,
            step: 16
        },
        //diagonal 2
        {
            indexes: [3, 6, 9, 12], //object and its property
            max: 16,
            step: 16
        }
    ];
